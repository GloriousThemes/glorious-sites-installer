...
class TG_Demo_Importer {
	...
	public function admin_menu() {
		add_theme_page( __( 'Demo Importer', 'glorious-sites-installer' ), __( 'Demo Importer', 'glorious-sites-installer' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
